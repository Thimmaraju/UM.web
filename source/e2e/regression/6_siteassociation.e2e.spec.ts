...
describe('Site association to a user', () => {
  let page: LoginPage;
  ...
  it('Assigning all sites to a user', async () => {
    ...
    edituser.assignAllSites();

  });


  it('Unassigning all sites to a user', async () => {
    browser.waitForAngularEnabled(false);
    util.navigateTo('/auth/login');
    browser.wait(ExpectedConditions.visibilityOf(page.getUserNameElement()));
