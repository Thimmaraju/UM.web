...
// models
import { PasswordPolicy } from '../../../../models/password-policy.interface';
import { Claims } from '../../../../services/omni-token/omni-token.service';

@Component({
  selector: 'pc-okta-change-password',
  styleUrls: ['./okta-change-password.component.scss'],
  template: `
...
export class OktaChangePasswordComponent implements OnInit, OnChanges {
